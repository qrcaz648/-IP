...
const SUB_PATH = process.env.SUB_PATH || '9852';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || '25e10dc5-d85e-4fbb-8761-1d8917643d74'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || '';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'qrcaz648.qrcaz648.dpdns.org';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMDIxN2NlMzFjOTI5MDgyMWI0ZWQ5MTU1MDE1Nzg4ZmYiLCJ0IjoiNzUzOTYzODctYzhlNS00OGE1LThmMjEtNDY1YWI5YjI2MTI2IiwicyI6Ik5qVmxaakZoTVdZdE5tVmxNaTAwWVRWbExXRmlPR0V0WldJNU1qazRObUl3TURZMyJ9
...
const NAME = process.env.NAME || 'miserable';                        // 节点名称
